...
const ContactBar: React.FC = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden grid grid-cols-3 divide-x divide-black bg-[#E63E26] text-center text-white shadow-[0_-2px_10px_rgba(0,0,0,0.2)]">
      <a
        href="tel:+3472216549"
        className="flex flex-col items-center justify-center py-3 hover:bg-[#c1341f] transition-colors"
      >
        <Phone size={24} />
