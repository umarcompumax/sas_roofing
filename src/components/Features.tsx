...
const features = [
  {
    id: '01',
    title: 'Safety\n& Reliability',
    description: 'Shielding Your Property with Unmatched Safety. Reliable Roofing.'
  },
  {
    id: '02',
    title: 'High Quality\nMaterials',
    description: 'Premium Materials for Superior Protection. Only the Best for Your Roof’s Durability.'
  },
  {
    id: '03',
    title: 'Professional\nTeam',
    description: 'Expert Hands, Exceptional Results. Trained Professionals, Trusted Solutions.'
  },
  {
    id: '04',
    title: 'Accredited\nService',
    description: 'Certified Excellence in Roofing & Waterproofing. Accredited for Quality'
  }
];
