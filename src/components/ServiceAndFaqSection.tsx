...
export default function ServiceAndFaqSection() {
  ...
  return (
    <div className="p-2 m-5 md:p-0 md:pb-1 md:m-0 md:mb-10 shadow-xl">
      <section className="relative w-full lg:h-[100vh] md:pt-5 pb-24 bg-[#f9f9f9] overflow-hidden border-t border-black/40">
